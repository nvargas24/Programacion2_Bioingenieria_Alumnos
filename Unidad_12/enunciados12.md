...
la función matemática: **$f(x) = 0.125x^2-0.7x+1$**, donde la variable $x$ representa el volumen de 
aire insuflado medido en litros. Dentro del rango de volumen seguro de **1.0 a 3.0** litros, determine el punto 
exacto de equilibrio de presión ejecutando el cálculo durante exactamente 8 iteraciones frente al valor real de **1.7564 litros**.
